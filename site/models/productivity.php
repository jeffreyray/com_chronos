...
class ChronosModelProductivity extends ChronosModelItem
{
	...
	*/
	public function populateState($ordering = null, $direction = null)
	{
		...
		if ($filter_source = $app->getUserState($this->context.'.filter.source'))
			$this->setState('filter.source', $filter_source, null, 'varchar');
