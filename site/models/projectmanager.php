...
* @subpackage	Classes
*/
class ChronosModelProjectmanager extends ChronosModelItem
{
	/**
	* View list alias
	*
	...
	* @var string
	*/
	protected $view_list = 'projectmanagers';
	...
	*/
	...
	/**
	* Method to delete a projectmanager
	*
	* @access	public
	...
	* @since	1.6
	*/
	public function getTable($type = 'projectmanager', $prefix = 'ChronosTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_chronos.edit.projectmanager.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('projectmanager.id') == 0)
			{
				$jinput = new JInput;
	...
	* @param	integer	$pk	The primary id key of the projectmanager
	* @return	void
	*/
