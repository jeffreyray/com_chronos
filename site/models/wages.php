...
class ChronosModelWages extends ChronosModelList
{
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_seach_comment : search on Comment
		$search_seach_comment = $this->getState('search.seach_comment');
		$this->addSearch('seach_comment', 'a.comment', 'like');
		if (($search_seach_comment != '') && ($search_seach_comment_val = $this->buildSearch('seach_comment', $search_seach_comment)))
			$this->addWhere($search_seach_comment_val);
