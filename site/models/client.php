...
* @subpackage	Classes
*/
class ChronosModelClient extends ChronosModelItem
{
	/**
	* View list alias
	*
	...
	*/
	...
	{
		$jinput = new JInput;
		return $jinput->get('layout', 'client', 'STRING');
	}
	...
	* @since	1.6
	*/
	public function getTable($type = 'client', $prefix = 'ChronosTable', $config = array())
	{
	...
	*/
	public function hit()
	{
		return parent::hit(array('client'));
	}
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_chronos.edit.client.data', array());
	...
	* @param	integer	$pk	The primary id key of the client
	* @return	void
	*/
