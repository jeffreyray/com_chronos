...
* @subpackage	Classes
*/
class ChronosModelThirdViewlevel extends ChronosModelItem
{
	/**
	* View list alias
	*
	...
	* @since	1.6
	*/
	public function getTable($type = 'thirdviewlevel', $prefix = 'ChronosTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_chronos.edit.viewlevel.data', array());
