...
class ChronosViewReferralsources extends JView
{
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		// New
		if ($model->canCreate())
			JToolBarHelper::addNew('referralsource.add', "CHRONOS_JTOOLBAR_NEW");

		// Edit
		if ($model->canEdit())
			JToolBarHelper::editList('referralsource.edit', "CHRONOS_JTOOLBAR_EDIT");

		// Delete
		if ($model->canDelete())
			JToolBarHelper::deleteList(JText::_('CHRONOS_JTOOLBAR_ARE_YOU_SURE_TO_DELETE'), 'referralsource.delete', "CHRONOS_JTOOLBAR_DELETE");
