...
<div class="grid_wrapper">
	...
	<thead>
		<tr>
			...
			<th style="text-align:left" width="25%">
				<?php echo JHTML::_('grid.sort',  "CHRONOS_FIELD_ALIAS", 'a.alias', $listDirn, $listOrder ); ?>
			</th>
			...
			<th class="order" style="text-align:center" width="15%">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++):
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<?php if ($this->canDo->get('core.edit') || $this->canDo->get('core.edit.state')): ?>
            <td class="order" style="text-align:center" width="15%">
