...
<div class="grid_wrapper">
	...
	<thead>
		<tr>
			...
			<th style="text-align:left">
				<?php echo JHTML::_('grid.sort',  "CHRONOS_FIELD_EMPLOYEE_NUMBER", '_employee_.number', $listDirn, $listOrder ); ?>
			</th>

			<th style="text-align:left">
				<?php echo JHTML::_('grid.sort',  "CHRONOS_FIELD_EMPLOYEE_FIRST_NAME", '_employee_.first_name', $listDirn, $listOrder ); ?>
			</th>
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td style="text-align:center">
				<?php echo JDom::_('html.grid.datetime', array(
										...
										'dataObject' => $row,
										'dateFormat' => "%Y-%m-%d",
												'href' => "javascript:listItemTask('cb" . $i . "', 'productivity.edit')"
											));
				?>
			</td>
