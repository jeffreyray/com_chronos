	...
	<thead>
		<tr>
			...
			<th style="text-align:left" width="10%">
				<?php echo JHTML::_('grid.sort',  "CHRONOS_FIELD_FIRST_NAME", '_employee_.first_name', $listDirn, $listOrder ); ?>
			</th>
			...
			<th style="text-align:center" width="10%">
				<?php echo JHTML::_('grid.sort',  "CHRONOS_FIELD_START", 'a.start', $listDirn, $listOrder ); ?>
			</th>
