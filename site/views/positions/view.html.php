...
* @subpackage	Positions
*/
class ChronosViewPositions extends JView
{
	/**
	...
	*/
	...
	/**
	* Execute and display a template : Positions
	*
	* @access	protected
	* @param	string	$tpl	The name of the template file to parse; automatically searches through the template paths.
	*
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		$document->title = $document->titlePrefix . JText::_("CHRONOS_LAYOUT_POSITIONS") . $document->titleSuffix;

		$this->model		= $model	= $this->getModel();
		$this->state		= $state	= $this->get('State');
		$state->set('context', 'positions.default');
		...
		JToolBarHelper::title(JText::_('CHRONOS_LAYOUT_POSITIONS'), 'chronos_positions');

		// Delete
		if ($model->canDelete())
			JToolBarHelper::deleteList(JText::_('CHRONOS_JTOOLBAR_ARE_YOU_SURE_TO_DELETE'), 'position.delete', "CHRONOS_JTOOLBAR_DELETE");
