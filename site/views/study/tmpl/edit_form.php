...
<fieldset class="fieldsform">
	...
	$fieldSet['jform_primary_manager']->jdomOptions = array(
			'list' => $this->lists['fk']['primary_manager']
		);
	$fieldSet['jform_secondary_manager']->jdomOptions = array(
			'list' => $this->lists['fk']['secondary_manager']
		);
