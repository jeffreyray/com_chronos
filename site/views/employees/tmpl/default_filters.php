...
//Deprecated
	...
	if ($('filter_search_name') != null)
	    $('filter_search_name').value='';
...
<fieldset id="filters" class="filters">
	...
	<div style="float:right;">
		<div style="float:left">
			<!-- SEARCH : filter_search_name : search on First Name  -->

				<div class='search filter filter_search_name'>

					<?php echo JDom::_('html.form.input.search', array(
											'domId' => 'filter_search_name',
											'dataKey' => 'filter_search_name',
											'dataValue' => $this->filters['search_name']->value,
											'label' => 'CHRONOS_FILTER_SEARCH_NAME'
												));
	...
	<div>
		...
		<div style="float:left">
			<!-- SELECT : Position > Label  -->
				...
				<div class='filter filter_position'>
		
					<?php echo JDom::_('html.form.input.select', array(
											'dataKey' => 'filter_position',
											'dataValue' => (string)$this->filters['position']->value,
											'list' => $this->filters['position']->list,
											'labelKey' => 'label',
											'nullLabel' => "CHRONOS_FILTER_NULL_POSITION",
											'submitEventName' => 'onchange'
												));
