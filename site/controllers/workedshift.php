...
/**
* Chronos Workedshift Controller
*
* @package	Chronos
* @subpackage	Workedshift
*/
class ChronosControllerWorkedshift extends ChronosControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'workedshift', 'CMD');
	}
