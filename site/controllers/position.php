...
/**
* Chronos Position Controller
*
* @package	Chronos
* @subpackage	Position
*/
class ChronosControllerPosition extends ChronosControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'viewposition', 'CMD');
	}
