...
/**
* Chronos Projectmanager Controller
*
* @package	Chronos
* @subpackage	Projectmanager
*/
class ChronosControllerProjectmanager extends ChronosControllerItem
{
	/**
	...
	* @var string
	*/
	protected $context = 'projectmanager';
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'view', 'CMD');
	}
