...
/**
* Chronos Client Controller
*
* @package	Chronos
* @subpackage	Client
*/
class ChronosControllerClient extends ChronosControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
					case 'default.add':
						$this->applyRedirection($result, array(
							'com_chronos.clients.default',
							'com_chronos.client.editclient'
						), array(
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'client', 'CMD');
	}
