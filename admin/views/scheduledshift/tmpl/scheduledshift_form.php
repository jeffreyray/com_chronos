...
?>
<?php $fieldSet = $this->form->getFieldset('scheduledshift.form');?>
<fieldset class="fieldsform">
	...
	$fieldSet['jform_employee']->jdomOptions = array(
			'list' => $this->lists['fk']['employee']
		);
	$fieldSet['jform_shift_type']->jdomOptions = array(
			'list' => $this->lists['fk']['shift_type']
		);
