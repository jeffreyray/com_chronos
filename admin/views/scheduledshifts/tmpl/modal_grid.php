...
<div class="grid_wrapper">
	...
	<thead>
		<tr>
			...
			<th align="left">
				<?php echo JHTML::_('grid.sort',  "CHRONOS_FIELD_EMPLOYEE", 'a.employee', $listDirn, $listOrder ); ?>
			</th>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++):
		...
		<tr class="<?php echo "row$k"; ?>"
			...
			onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $row->id; ?>', '<?php echo $this->escape(addslashes($row->employee)); ?>', 'cid');">
