...
class ChronosViewShifttypes extends JView
{
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		// New
		if ($model->canCreate())
			JToolBarHelper::addNew('shifttype.add', "JTOOLBAR_NEW");

		// Edit
		if ($model->canEdit())
			JToolBarHelper::editList('shifttype.edit', "JTOOLBAR_EDIT");

		// Delete
		if ($model->canDelete())
			JToolBarHelper::deleteList(JText::_('CHRONOS_JTOOLBAR_ARE_YOU_SURE_TO_DELETE'), 'shifttype.delete', "JTOOLBAR_DELETE");
