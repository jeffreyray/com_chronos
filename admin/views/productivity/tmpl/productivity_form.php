...
?>
<?php $fieldSet = $this->form->getFieldset('productivity.form');?>
<fieldset class="fieldsform">
	<dl>

	<?php
	// JForms dynamic initialization (Cook Self Service proposal)
	$fieldSet['jform_employee']->jdomOptions = array(
			'ajaxVars' => array('values' => array(
				$this->item->employee
					))
		);
	$fieldSet['jform_study']->jdomOptions = array(
			'ajaxVars' => array('values' => array(
				$this->item->study
					))
		);
	$fieldSet['jform_source']->jdomOptions = array(
			'list' => $this->lists['select']['source']->list
		);
