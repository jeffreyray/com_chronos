...
class ChronosViewUmbrellas extends JView
{
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		// New
		if ($model->canCreate())
			JToolBarHelper::addNew('umbrella.add', "JTOOLBAR_NEW");

		// Edit
		if ($model->canEdit())
			JToolBarHelper::editList('umbrella.edit', "JTOOLBAR_EDIT");

		// Delete
		if ($model->canDelete())
			JToolBarHelper::deleteList(JText::_('CHRONOS_JTOOLBAR_ARE_YOU_SURE_TO_DELETE'), 'umbrella.delete', "JTOOLBAR_DELETE");
