...
/**
* Chronos Terminationreason Controller
*
* @package	Chronos
* @subpackage	Terminationreason
*/
class ChronosControllerTerminationreason extends ChronosControllerItem
{
	/**
	...
	* @var string
	*/
	protected $context = 'terminationreason';
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'terminationreason', 'CMD');
	}
