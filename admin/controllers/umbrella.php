...
/**
* Chronos Umbrella Controller
*
* @package	Chronos
* @subpackage	Umbrella
*/
class ChronosControllerUmbrella extends ChronosControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'umbrella', 'CMD');
	}
