...
/**
* Chronos Productivity Controller
*
* @package	Chronos
* @subpackage	Productivity
*/
class ChronosControllerProductivity extends ChronosControllerItem
{
	/**
	...
	* @var string
	*/
	protected $context = 'productivity';
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'productivity', 'CMD');
	}
