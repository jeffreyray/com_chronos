...
/**
* Chronos Referralsource Controller
*
* @package	Chronos
* @subpackage	Referralsource
*/
class ChronosControllerReferralsource extends ChronosControllerItem
{
	/**
	...
	* @var string
	*/
	protected $context = 'referralsource';
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'referralsource', 'CMD');
	}
