...
/**
* Chronos Facility Controller
*
* @package	Chronos
* @subpackage	Facility
*/
class ChronosControllerFacility extends ChronosControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		$jinput = new JInput;
		return $jinput->get('layout', 'facility', 'CMD');
	}
