...
* @subpackage	Classes
*/
class ChronosModelReferralsources extends ChronosModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_search : search on Note
		$search_search = $this->getState('search.search');
		$this->addSearch('search', 'a.note', 'like');
