...
* @subpackage	Classes
*/
class ChronosModelShifttype extends ChronosModelItem
{
	/**
	* View list alias
	*
	...
	* @var string
	*/
	protected $view_list = 'shifttypes';
	...
	*/
	...
	{
		$jinput = new JInput;
		return $jinput->get('layout', 'shifttype', 'STRING');
	}
	...
	* @since	1.6
	*/
	public function getTable($type = 'shifttype', $prefix = 'ChronosTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_chronos.edit.shifttype.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('shifttype.id') == 0)
			{
				$jinput = new JInput;
	...
	* @param	integer	$pk	The primary id key of the shifttype
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		//FROM : Main table
		$query->from('chr_shifttypes AS a');
